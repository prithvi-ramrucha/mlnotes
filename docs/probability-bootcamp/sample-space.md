...
In probability theory, we consider **experiments** as abstraction for a thing that can happen: flipping a coin, rolling a dice, selecting a card from a deck of them, etc. The result, observation or measurement at 
